    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="item-1" className="bg-white rounded-2xl px-6 border border-gray-200 hover:border-blue-300 transition-colors">
                ...
                <AccordionContent className="text-gray-600 leading-relaxed">
                  WorkLedger tracks your team's development activity from connected platforms like GitHub and GitLab. This includes commits, pull requests, code reviews, and programming languages used. We analyze this data to detect skills, measure growth, and generate insights - all while keeping your code private and secure.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-2" className="bg-white rounded-2xl px-6 border border-gray-200 hover:border-blue-300 transition-colors">
                <AccordionTrigger className="text-lg font-semibold text-gray-900 hover:no-underline">
                  How does skill detection work?
                </AccordionTrigger>
                <AccordionContent className="text-gray-600 leading-relaxed">
                  Our AI-powered skill detection analyzes your team's code contributions across repositories. We identify programming languages, frameworks, libraries, and development patterns. Skills are categorized by proficiency level based on frequency, complexity, and consistency of usage over time.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-3" className="bg-white rounded-2xl px-6 border border-gray-200 hover:border-blue-300 transition-colors">
                <AccordionTrigger className="text-lg font-semibold text-gray-900 hover:no-underline">
                  How can I verify certificates?
                </AccordionTrigger>
                <AccordionContent className="text-gray-600 leading-relaxed">
                  Each certificate generated by WorkLedger includes a unique verification code and QR code. Anyone can verify a certificate's authenticity by visiting our verification portal and entering the code. The verification page shows the certificate details, issue date, and the skills it represents.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-4" className="bg-white rounded-2xl px-6 border border-gray-200 hover:border-blue-300 transition-colors">
                <AccordionTrigger className="text-lg font-semibold text-gray-900 hover:no-underline">
                  Can employees export their certificates?
                </AccordionTrigger>
                <AccordionContent className="text-gray-600 leading-relaxed">
                  Yes! Employees can download their certificates as PDF files or share them directly to LinkedIn and other professional networks. Certificates are portable and belong to the employee - they can take them wherever they go in their career.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-5" className="bg-white rounded-2xl px-6 border border-gray-200 hover:border-blue-300 transition-colors">
                <AccordionTrigger className="text-lg font-semibold text-gray-900 hover:no-underline">
                  How do I integrate with GitHub?
                </AccordionTrigger>
                <AccordionContent className="text-gray-600 leading-relaxed">
                  Integration is simple! Just click "Connect GitHub" in your dashboard and authorize WorkLedger to access your organization's repositories. You can select which repositories to include, and we'll start analyzing your team's contributions immediately. The setup takes less than 5 minutes.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-6" className="bg-white rounded-2xl px-6 border border-gray-200 hover:border-blue-300 transition-colors">
                <AccordionTrigger className="text-lg font-semibold text-gray-900 hover:no-underline">
                  Is WorkLedger suitable for remote teams?
                </AccordionTrigger>
                <AccordionContent className="text-gray-600 leading-relaxed">
                  Absolutely! WorkLedger is perfect for remote and distributed teams. Since we track activity through code platforms like GitHub, it doesn't matter where your team members are located. Get visibility into your global team's growth and skills from a single dashboard.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
      ...
      <footer className="py-16 bg-gray-50 border-t">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-5 gap-8 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-sm text-gray-600 mb-6 max-w-xs">
                Your team's growth, verified and tracked. Turn your development activity into recognized achievements.
              </p>
              {/* Social Links */}
              <div className="flex items-center gap-4">
                <a href="https://twitter.com/workledger" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-600 hover:text-blue-600 hover:border-blue-300 transition-colors">
                  <Twitter className="h-4 w-4" />
                </a>
                <a href="https://linkedin.com/company/workledger" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-600 hover:text-blue-600 hover:border-blue-300 transition-colors">
                  <Linkedin className="h-4 w-4" />
                </a>
                <a href="https://github.com/workledger" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-600 hover:text-blue-600 hover:border-blue-300 transition-colors">
                  <Github className="h-4 w-4" />
                </a>
                <a href="mailto:hello@workledger.com" className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-600 hover:text-blue-600 hover:border-blue-300 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-600">
                ...
                <li><Link href="/#testimonials" className="hover:text-blue-600 transition-colors">Reviews</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-600">
                ...
                <li><Link href="/verify" className="hover:text-blue-600 transition-colors flex items-center gap-1.5">
                  <BadgeCheck className="h-3.5 w-3.5" />
                  Verify Certificate
                </Link></li>
                <li><a href="mailto:support@workledger.com" className="hover:text-blue-600 transition-colors">Support</a></li>
              </ul>
            </div>
          ...
          <div className="pt-8 border-t flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
            <p>© 2025 WorkLedger. All rights reserved.</p>
            <p className="flex items-center gap-1">
              Made with <span className="text-red-500">♥</span> for teams everywhere
            </p>
          </div>
        </div>
      </footer>
